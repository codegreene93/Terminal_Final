...
class PurchaseordersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchaseorder" do
    assert_difference('Purchaseorder.count') do
      post purchaseorders_url, params: { purchaseorder: { cost: @purchaseorder.cost, description: @purchaseorder.description, orderno: @purchaseorder.orderno, supplier: @purchaseorder.supplier } }
    end
  ...
  test "should update purchaseorder" do
    patch purchaseorder_url(@purchaseorder), params: { purchaseorder: { cost: @purchaseorder.cost, description: @purchaseorder.description, orderno: @purchaseorder.orderno, supplier: @purchaseorder.supplier } }
